...
if(!empty($_GET['search'])){
    ...
    $sql = "SELECT * FROM agendamentos ORDER BY idagendamentos DESC";
}
...
<body>
    ...
    <!--<a href="historico-agendamentos-atikum.php">ATIKUM</a>
        <a href="historico-agendamentos-atikumsalgueiro.php">ATIKUM SALGUEIRO</a>
        <a href="historico-agendamentos-funilo.php">FUNIL-Ô</a>
        <a href="historico-agendamentos-kambiwa.php">KAMBIWÁ</a>
        <a href="historico-agendamentos-kapinawa.php">KAPINAWÁ</a>
        <a href="historico-agendamentos-pipipa.php">PIPIPÃ</a>
        <a href="historico-agendamentos-truka.php">TRUKÁ</a>
        <a href="historico-agendamentos-tuxa.php">TUXÁ</a>
        <a href="historico-agendamentos-tuxi.php">TUXÍ</a>
        <a href="historico-agendamentos-xukurucimbres.php">XUKURU DE CIMBRES</a>
        <a href="historico-agendamentos-xukuruororuba.php">XUKURU DE ORORUBA</a>
        <a href="historico-agendamentos-novembro.php">OUTROS</a>
    -->
    </div>
